...
| 2026-08-05 | CI 平台矩阵扩展 | tests job 覆盖 Ubuntu/Windows/macOS 三平台 × 3 Python（3×3），统一 bash shell；quality/package 保持 Linux（静态检查平台无关） | `.github/workflows/tests.yml`；`docs/development_compatibility.md` | 4 项质量门禁 + ruff 通过；本地 Windows `534 passed` |

...
> 审计日:2026-08-09 | 快照更新:2026-08-15(治理复核)
...
| 快照更新 | 2026-08-15:红项全部闭环复核;黄项 17 项中 10 项随治理批次闭环,6 项部分修复,1 项原样 |
...
| 项 | 现状 | 证据 | 建议 |
|---|---|---|---|
| S2 pipeline.py 单文件大(局部恶化) | 938→1119 行,fit_evaluate 仍 ~206 行内联 | `pu_toolbox/workflows/pipeline.py` | 按阶段拆内部函数 |

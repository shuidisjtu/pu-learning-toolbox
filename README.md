...
**Positive-Unlabeled learning in Python** -- 21 registered algorithms, research joint-shift adaptation, SCAR & SAR support.
...
- **21 registered algorithms** from recent PU learning research, all native clean-room implementations, plus an isolated research joint-shift solver ([method cards](docs/research/method_cards/))
